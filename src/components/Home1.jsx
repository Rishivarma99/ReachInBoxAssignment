const Home1 = () => {
  return (
    <>
      <div className="w-full h-full flex justify-center pt-20 bg-black">
        <div className="mx-auto flex flex-col gap-y-3 p-2 ">
            ...
            >
              ...
              <defs>
                <filter
                  ...
                  colorfnterpolationfilters="sRGB"
                >
                  <feFlood
                    floodOpacity="0"
                ...
                >
                  <stop stopColor="#21262D"></stop>
                  <stop offset="1" stopColor="#BCD8FF"></stop>
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#EDF4FF"></stop>
                  <stop offset="1" stopColor="#ABCCFF"></stop>
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#ABCCFF"></stop>
                  <stop offset="1" stopColor="#70A8FF"></stop>
                </linearGradient>
                <linearGradient
                ...
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#70A8FF"></stop>
                  <stop offset="1" stopColor="#5597FD"></stop>
                </linearGradient>
                <linearGradient
                ...
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#94BFFF"></stop>
                  <stop offset="1" stopColor="#4C94FE"></stop>
                </linearGradient>
                <linearGradient
          ...
          <p className=" text-sm text-center text-[#94a3b8]">
            When you have inbound Emails <br /> you will see them here
          </p>
        </div>
      </div>
    </>
